...
if (Cypress.env("edition") === "iso") {
  ...
  describe("Scenario 8 - Instance Composer", async () => {
    ...
    it("8.1 composer opens up has its default panning working", () => {
      ...
      cy.get("#container-service", { timeout: 60000 }).contains("Show inventory").click();
    ...
    it("8.2 composer create view can perform its required functions and deploy created instance", () => {
      ...
      cy.get("#parent-service", { timeout: 60000 }).contains("Show inventory").click();
      ...
      cy.get('[data-type="app.ServiceEntityBlock"').contains("parent-service").click();
      ...
      cy.get('[data-testid="Composer-Container"]').within(() => {
        cy.get("button").contains("span", "Cancel").parent().should("be.disabled");
        cy.get("button").contains("span", "Remove").parent().should("be.disabled");
      });
      ...
      cy.get('[data-testid="Composer-Container"]').within(() => {
        cy.get("button").contains("span", "Cancel").parent().should("be.enabled");
      ...
      cy.get('[aria-label="TextInput-name"]').type("test_name");
      cy.get('[aria-label="TextInput-service_id"]').type("test_id");
      cy.get('[joint-selector="itemLabel_name"]').contains("name").should("be.visible");

      cy.get('[joint-selector="itemLabel_name"]').contains("name").should("be.visible");
      cy.get('[joint-selector="itemLabel_name_value"]').contains("test_name").should("be.visible");
      ...
      cy.get("#many-defaults", { timeout: 60000 }).contains("Show inventory").click();
      cy.get('[aria-label="ServiceInventory-Empty"]').should("to.be.visible");
      // click on add instance with composer
      cy.get('[aria-label="AddInstanceToggle"]').click();
      cy.get("#add-instance-composer-button").click();
      ...
      cy.get('[data-type="app.ServiceEntityBlock"').should("have.length", 2);
      cy.get('[data-testid="header-EmbeddedWithDefaultsPrimary"]').should("be.visible");
      cy.get('[data-type="app.ServiceEntityBlock"').contains("many-defaults").should("be.visible");
      ...
      cy.get("#instance-stencil").within(() => {
        ...
        cy.get('[aria-labelledby="bodyTwo_extra_embedded"]').should("be.visible");
      ...
      cy.get('[data-type="app.ServiceEntityBlock"').contains("many-defaults").click();
      cy.get("button").contains("span", "Remove").parent().should("be.disabled");
      ...
      cy.get('[aria-label="TextInput-default_string"]').type("{backspace}default_string");
      cy.get('[aria-label="TextInput-default_empty_string"]').type("default_string_1");
      cy.get('[aria-label="TextInput-default_nullable_string"]').type("default_string_2");

      //ints
      cy.get('[aria-label="TextInput-default_int"]').type("{backspace}20");
      cy.get('[aria-label="TextInput-default_empty_int"]').type("{backspace}30");
      cy.get('[aria-label="TextInput-default_nullable_int"]').type("{backspace}40");

      //floats
      cy.get('[aria-label="TextInput-default_float"]').type("{backspace}2.0");
      cy.get('[aria-label="TextInput-default_empty_float"]').type("{backspace}3.0");
      cy.get('[aria-label="TextInput-default_nullable_float"]').type("{backspace}4.0");
      ...
      cy.get('[aria-label="TextInput-default_nullable_dict"]').type('{{}"test2":"value2"{}}');

      //assert that embedded instance have all attributes, this particular embedded entity can't be removed but can be edited
      cy.get('[data-testid="header-EmbeddedWithDefaultsPrimary"]').click();
      cy.get("button").contains("span", "Remove").parent().should("be.disabled");
      cy.get("input").should("have.length", 21);
      ...
      cy.get('[aria-label="TextInput-default_nullable_int"]').type("{backspace}41");

      //floats
      cy.get('[aria-label="TextInput-default_float"]').type("{backspace}2.1");
      cy.get('[aria-label="TextInput-default_empty_float"]').type("{backspace}3.1");
      cy.get('[aria-label="TextInput-default_nullable_float"]').type("{backspace}4.1");
      ...
      cy.get('[data-testid="header-EmbeddedWithDefaultsSecondary"]').click();
      ...
      cy.get('[data-testid="header-EmbeddedWithDefaultsSecondary"]').should("not.exist");
      ...
      //ints
      cy.get('[aria-label="TextInput-default_int"]').type("{backspace}21");
      cy.get('[aria-label="TextInput-default_empty_int"]').type("{backspace}31");
      cy.get('[aria-label="TextInput-default_nullable_int"]').type("{backspace}41");
      ...
      cy.get('[data-label="State"]', { timeout: 90000 }).should("have.text", "up");
    ...
    it("8.3 composer edit view can perform it's required functions and deploy edited instance", () => {
      ...
      cy.get('[data-testid="header-EmbeddedWithDefaultsPrimary"]').should("be.visible");
      cy.get('[data-testid="header-EmbeddedWithDefaultsSecondary"]').should("be.visible");
      cy.get('[data-type="app.ServiceEntityBlock"]').contains("many-defaults").should("be.visible");
      ...
      cy.get('[aria-label="default_string_value"]').should("have.text", "updated_string");

      cy.get('[aria-label="Expand row 1"]').click(); //toggle embedded

      cy.get('[aria-label="embedded.default_int_value"]').should("have.text", "22");
      cy.get('[aria-label="embedded.default_float_value"]').should("have.text", "2");
      cy.get('[aria-label="embedded.default_string_value"]').should("have.text", "updated_string");
    ...
    it("8.4 composer edit view is able to edit instances relations", () => {
      ...
      cy.get('[aria-label="Sidebar-Navigation-Item"]').contains("Service Catalog").click();
      // click on Show Inventory of many-defaults service, expect no instances
      cy.get("#child-service", { timeout: 60000 }).contains("Show inventory").click();
      cy.get('[aria-label="ServiceInventory-Empty"]').should("to.be.visible");
      // click on add instance with composer
      cy.get('[aria-label="AddInstanceToggle"]').click();
      cy.get("#add-instance-composer-button").click();
      ...
      cy.get('[data-testid="Error-container"]').should("have.text", "Danger alert:Errors found: 1");
      cy.get('[aria-label="Danger alert details"]').click();
      cy.get('[aria-label="missingRelationsParagraph-child-service_parent-service_0"]').should(
        "have.text",
      ...
      cy.get('[data-type="app.ServiceEntityBlock"').contains("child-service").click();
      cy.get('[data-action="link"]')
        .trigger("mouseover")
        .trigger("mousedown")
        .trigger("mousemove", {
      ...
      // await until parent_service is deployed and up
      cy.get('[data-label="State"]', { timeout: 90000 }).should("have.text", "update_start");
      // await until parent_service is deployed and up
      cy.get('[data-label="State"]', { timeout: 90000 }).should("have.text", "up");
      ...
      cy.get('[aria-label="left-side-attribute-set-select"]').select("active_attributes");
    ...
    it("8.5 composer edit view is able to remove inter-service relation from instance", () => {
      ...
      cy.get('[data-type="app.ServiceEntityBlock"').contains("child-with-many").click();
      ...
      cy.get('[data-type="app.ServiceEntityBlock"').contains("test_name2").click();
