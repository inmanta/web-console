...
// parts of the ZoomHandlerService that aren't covered are related to the getElementById part as they aren't working on jest, and mocking is pointless and zoomHandler is also covered in the cypress
