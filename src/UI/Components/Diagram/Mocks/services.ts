    ...
    lifecycle: {
      ...
      transfers: [
        ...
        },
        {
          ...
          config_name: null,
          description:
            "delete_validating_creating to delete_validating_creating",
          target_operation: null,
          error_operation: null,
        },
        {
  ...
  },
  {
    attributes: [
      ...
      },
      {
        name: "name",
        description:
          "The name of the bitstream, it should be unique by onu it is configured for.\ni.e. HSIA, TV, etc.",
        modifier: "rw",
        attribute_annotations: {},
        type: "string",
        default_value: null,
      ...
      },
      {
        name: "customerElid",
        description:
          "The internal identifier of the customer, in FNT's inventory.",
        modifier: "rw",
        attribute_annotations: {},
        type: "string",
        default_value: null,
      ...
      {
        name: "customerLocationElid",
        description:
          "The internal identifier of the customer location where the\nont is installed, in FNT's inventory.",
        modifier: "rw",
        attribute_annotations: {},
        type: "string",
        default_value: null,
      ...
      {
        name: "servcoReference",
        description:
          "The name of the service connectivity provider, that can be found\nin FNT's inventory.",
        modifier: "rw",
        attribute_annotations: {},
        type: "string",
        default_value: null,
      ...
      {
        name: "qos",
        description: "The quality of service for the bitstream connection.",
        modifier: "rw+",
        attribute_annotations: {},
        type: "string",
        default_value: null,
      ...
      {
        name: "bandwidth",
        description: "The bandwidth available to the bistream connection.",
        modifier: "rw+",
        attribute_annotations: {},
        type: "int",
        default_value: null,
      ...
      },
      {
        name: "serviceId",
        description:
          "Internal identifier for the epipe deployed from the OLT's PE to the Servco' PE.",
        modifier: "r",
        attribute_annotations: {},
        type: "int?",
        default_value: null,
      ...
      {
        name: "oltVlanId",
        description: "The vlan identifier for the link OLT <> PE",
        modifier: "r",
        attribute_annotations: {},
        type: "int?",
        default_value: null,
      ...
      {
        name: "nniVlanId",
        description: "The vlan identifier for the servco uplink.",
        modifier: "r",
        attribute_annotations: {},
        type: "int?",
        default_value: null,
    ...
    inter_service_relations: [],
    entity_annotations: {},
    environment: "72c8aa68-c1d4-44bd-8914-e509fdadc24e",
    name: "FtthBitStream",
    description: "Bit stream connection from a onu interface to a remote uni.",
    lifecycle: {
      states: [
        {
          name: "update_rejected_failed",
    ...
    service_identity_display_name: "Order",
    strict_modifier_enforcement: true,
    owner: null,
    relation_to_owner: null,
    instance_summary: {
