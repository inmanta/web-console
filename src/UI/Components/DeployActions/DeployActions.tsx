...
import { ResourceActionConfirmModal, ScopeOption } from "./ResourceActionConfirmModal";
 ...
 *  @prop {ScopeOption[]} [scopes] - The scopes offered in the confirm dialog (first is the default)
