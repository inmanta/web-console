...
export const CompoundResourceStatus = (props: CompoundResourceProps) => {
  ...
  const statusRows: Array<{
  ...
  }> = [
    {
      ...
      items: [
        { status: Resource.CompoundStatus.blocked, value: blocked.blocked },
        { status: Resource.CompoundStatus.not_blocked, value: blocked.not_blocked },
        { status: Resource.CompoundStatus.temporarily_blocked, value: blocked.temporarily_blocked },
      ],
    },
    {
      ...
      items: [
        { status: Resource.CompoundStatus.compliant, value: compliance.compliant },
        { status: Resource.CompoundStatus.has_update, value: compliance.has_update },
        { status: Resource.CompoundStatus.non_compliant, value: compliance.non_compliant },
        { status: Resource.CompoundStatus.undefined, value: compliance.undefined },
      ],
    },
    {
      ...
      items: [
        { status: Resource.CompoundStatus.failed, value: lastHandlerRun.failed },
        { status: Resource.CompoundStatus.new, value: lastHandlerRun.new },
        { status: Resource.CompoundStatus.skipped, value: lastHandlerRun.skipped },
        { status: Resource.CompoundStatus.successful, value: lastHandlerRun.successful },
      ],
    },
  ];
