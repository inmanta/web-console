...
vi.mock("../Helpers/deploymentHelpers", () => ({
    canvasStateToServiceOrderItems: vi.fn((canvasState, initialShapeInfo, serviceCatalog) => {
...
describe("useServiceOrderItems", () => {
    ...
    it("should update when initialShapeInfoRef changes", async () => {
        ...
        const newInitialShapeInfoRef = { current: new Map([["shape-2", { service_entity: "Entity2" }]]) };
