...
export const useCanvasInteractions = ({
    ...
    useEffect(() => {
        ...
        const handleCellContextMenu = (cellView: dia.CellView, event: dia.Event) => {
            ...
            const canRemove = graph ? canRemoveShape(cell, graph, relationsDictionary, serviceCatalog) : true;
            ...
            if ((cell.entityType === "core" || cell.entityType === "relation") && canRemove && !cell.isNew) {
    ...
    }, [paper, graph, scroller, editable, relationsDictionary, activeCell, setActiveCell, setFormState, initialShapeInfoRef, serviceCatalog]);
};
