...
import { ServiceModel, ServiceInstanceModel, InstanceWithRelations } from "@/Core";
...
describe("initializeCanvasFromInstance", () => {
    ...
    it("should create shapes from instance data", () => {
        ...
        const result = initializeCanvasFromInstance(instanceData, serviceCatalog, relationsDictionary, graph);
