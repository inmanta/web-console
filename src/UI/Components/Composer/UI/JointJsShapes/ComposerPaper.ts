  ...
  constructor(
    ...
    this.paper = new dia.Paper({
      ...
      validateConnection: (sourceView, srcMagnet, targetView, tgtMagnet) => {
        ...
        const sourceEntityBlock: ServiceEntityShape | undefined = serviceEntityShapes.find(
          (entity) => entity.cid === sourceView.model.cid
        );
        const targetEntityBlock: ServiceEntityShape | undefined = serviceEntityShapes.find(
          (entity) => entity.cid === targetView.model.cid
        );
