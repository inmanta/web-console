...
export const ZoomControlsContainer = styled.div`
  position: absolute;
  bottom: 25px;
  // Centre the toolbar in the canvas, clear of the 240px left sidebar and the 350px
  // (plus 1px offset) right details sidebar so it never overlaps the details form.
  left: 240px;
  right: 351px;
  margin-inline: auto;
  width: max-content;
