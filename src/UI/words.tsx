...
const dict = {
  ...
  "resources.filters.resource.type.hint": "Matches any resource whose type contains this text.",
  "resources.filters.resource.value.placeholder": "Value...",
  "resources.filters.resource.value.hint": "Matches any resource whose value contains this text.",
  "resources.filters.resource.agent.label": "Agent(s)",
  "resources.filters.resource.agent.placeholder": "Select Agent(s)",
  "resources.filters.resource.agent.hint": "Matches any resource whose agent contains this text.",
