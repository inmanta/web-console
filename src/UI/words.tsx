...
const dict = {
  ...
  "dashboardV2.environmentHealth.status.healthy": "Healthy",
  "dashboardV2.environmentHealth.status.attention": "Attention",
  "dashboardV2.environmentHealth.status.danger": "Danger",
  "dashboardV2.environmentHealth.viewDetails": (title: string) => `View ${title} details`,
  ...
  "dashboardV2.compileReports.viewAll": "View all compile reports",
  "dashboardV2.compileReports.empty": "No compile reports yet",
  "dashboardV2.compileReports.running": "Running…",
  "dashboardV2.compileReports.queued": "Queued",
  "dashboardV2.compileReports.startedAgo": "started",
