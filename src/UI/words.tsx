...
const dict = {
  ...
  "dashboard.environmentHealth.resources": "Resources",
  ...
  "dashboard.orchestrator.version": "Version",
  ...
  "resourceActions.title": "Changelog",
  "resourceActions.empty.message": "No resource actions found",
  "resourceActions.column.started": "Deploy start",
  ...
  "resourceActions.column.actionId": "Action ID",
  "resourceActions.column.version": "Version",
  "resourceActions.column.status": "Status",
  "resourceActions.column.resources": "Resources",
  "resourceActions.details.viewLogs": "View logs",
  "resourceActions.filter.resourceType": "Resource Type",
  "resourceActions.filter.resourceType.placeholder": "Filter by resource type...",
  "resourceActions.filter.agent": "Agent",
  "resourceActions.filter.agent.placeholder": "Filter by agent...",
  "resourceActions.filter.value": "Value",
  "resourceActions.filter.value.placeholder": "Filter by value...",
  "resourceActions.filter.change": "Change",
  "resourceActions.filter.change.placeholder": "Filter by change...",
