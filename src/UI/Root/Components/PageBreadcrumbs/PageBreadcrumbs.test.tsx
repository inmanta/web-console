...
test("GIVEN Breadcrumbs WHEN service name is double encoded THEN decoded label is shown", () => {
  ...
  console.log("Number of crumbs:", crumbs.length);

  crumbs.forEach((crumb, index) => {
    console.log(`Crumb ${index} text:`, crumb.textContent);
  });

  const [, , inventoryCrumb] = crumbs;

  const label = within(inventoryCrumb).getByText(/Service Inventory/);
  console.log("Inventory crumb label:", label.textContent);
