...
export class CommandManagerResolverImpl implements CommandManagerResolver {
  ...
  private getManagers(): CommandManager[] {
    const environmentDetailsStateHelper = GetEnvironmentDetailsStateHelper(this.store);
    ...
    const environmentDetailsUpdater = new EnvironmentDetailsUpdater(this.store, this.apiHelper);

    return [
      new DeleteEnvironmentCommandManager(
        this.apiHelper,
        new EnvironmentsUpdater(GetEnvironmentsStateHelper(this.store), this.apiHelper)
      ),
