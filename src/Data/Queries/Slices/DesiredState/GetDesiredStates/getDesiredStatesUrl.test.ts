...
it.each`
  ...
  ${{ date: [{ operator: "from", date: new Date("2021-12-05T23:30:00.000Z") }] }} | ${"20"}  | ${""}                                                        | ${"/api/v2/desiredstate?limit=20&sort=version.desc&filter.date=ge%3A2021-12-05%2B23%3A30%3A00"}
