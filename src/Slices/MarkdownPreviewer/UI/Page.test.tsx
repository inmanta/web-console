...
describe("MarkdownPreviewer", () => {
    ...
    it("should render successfully with all required props", async () => {
        ...
        await waitFor(() => {
            ...
            expect(screen.getByText(`Markdown Preview: ${instanceData.service_entity}: ${instanceData.id}`)).toBeVisible();
    ...
    it("should handle dark theme correctly", async () => {
        // Mock getThemePreference to return dark
        jest.spyOn(require("@/UI/Components/DarkmodeOption"), "getThemePreference").mockReturnValue("dark");
