 ...
 * @property {Function} [onCreateMenu] - every time the menu is being trigered,
 * it is rebuilt from scratch.
 * Custom items can then be passed.
 * first argument are the menuItems, the second the node on which the menu is being invoked on.
