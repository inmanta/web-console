...
const getServiceModelError = http.get("/lsm/v1/service_catalog/mobileCore", () => {
...
const getServiceModelWithConfig = http.get("/lsm/v1/service_catalog/mobileCore", async () => {
  return HttpResponse.json({
    data: serviceModelWithConfig,
  });
});

const getHistoryLogs = http.get("/lsm/v1/service_inventory/mobileCore/1d96a1ab/log", async () => {
  return HttpResponse.json(logsResponse);
});

const getHistoryLogsError = http.get("/lsm/v1/service_inventory/mobileCore/1d96a1ab/log", () => {
  return HttpResponse.json({ message: "Not Found" }, { status: 404 });
});
...
const getInstanceData = http.get("/lsm/v1/service_inventory/mobileCore/1d96a1ab", () => {
  return HttpResponse.json({
    data: instanceData,
  });
});

const getInstanceError = http.get("/lsm/v1/service_inventory/mobileCore/1d96a1ab", () => {
  return HttpResponse.json({ message: "Not Found" }, { status: 404 });
});
...
const getJSONSchema = http.get("/lsm/v1/service_catalog/mobileCore/schema", () => {
  return HttpResponse.json({
    data: JSONSchema,
  });
});
...
const deleteInstance = http.delete("lsm/v1/service_inventory/mobileCore/1d96a1ab", async () => {
  return HttpResponse.json({ status: 200 });
});
