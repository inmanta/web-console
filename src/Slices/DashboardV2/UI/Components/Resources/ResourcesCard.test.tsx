...
describe("ResourcesCard", () => {
  ...
  it("shows the title, per-status legend counts and the 4-tile summary", async () => {
    ...
    expect(screen.getByText(words("dashboardV2.resourceManager.title"))).toBeVisible();
    expect(screen.getByText(words("dashboardV2.resourceManager.subtitle"))).toBeVisible();
    ...
    // the wrong count.
    expectStatTile("brand", words("dashboardV2.resourceManager.deployingNow"), "1");
    expectStatTile("success", words("dashboardV2.resourceManager.deployedOk"), "2");
    expectStatTile("danger", words("dashboardV2.resourceManager.failed"), "1");
    expectStatTile("warning", words("dashboardV2.resourceManager.nonCompliant"), "1");

    expect(screen.getByText(words("dashboardV2.resourceManager.summaryCount")(106))).toBeVisible();
  });
