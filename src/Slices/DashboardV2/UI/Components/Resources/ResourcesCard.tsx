...
export const ResourcesCard: React.FC = () => {
  ...
  const statTiles: { label: string; value: number; tone: keyof typeof STAT_TONE_COLOR }[] = [
    {
      label: words("dashboardV2.resourceManager.deployingNow"),
      value: summary?.isDeploying.true ?? 0,
      tone: "brand",
    },
    {
      label: words("dashboardV2.resourceManager.deployedOk"),
      value: summary?.lastHandlerRun.successful ?? 0,
      tone: "success",
    },
    {
      label: words("dashboardV2.resourceManager.failed"),
      value: summary?.lastHandlerRun.failed ?? 0,
      tone: "danger",
    },
    {
      label: words("dashboardV2.resourceManager.nonCompliant"),
    ...
    <Card isFullHeight>
        ...
        <CardTitle>
          ...
          >
            ...
            <Flex direction={{ default: "column" }} spaceItems={{ default: "spaceItemsNone" }}>
              <FlexItem>
                <Content component="h3">{words("dashboardV2.resourceManager.title")}</Content>
              </FlexItem>
              <FlexItem>
                <Content component="small">{words("dashboardV2.resourceManager.subtitle")}</Content>
              </FlexItem>
            </Flex>
          </Flex>
        </CardTitle>
      ...
      <CardBody>
        <Flex direction={{ default: "column" }} spaceItems={{ default: "spaceItemsMd" }}>
          <FlexItem>
            <ResourceStatusBar
              title={words("dashboardV2.resourceManager.compliance.title")}
          ...
          <FlexItem>
            <ResourceStatusBar
              title={words("dashboardV2.resourceManager.deployResult.title")}
          ...
          <FlexItem>
            <ResourceStatusBar
              title={words("dashboardV2.resourceManager.blocked.title")}
          ...
          >
            <FlexItem>
              <Content component="p" style={{ fontWeight: 700 }}>
                {words("dashboardV2.resourceManager.summary")}
              </Content>
            </FlexItem>
            <FlexItem>
              <Label isCompact>
                {words("dashboardV2.resourceManager.summaryCount")(totalCount)}
              </Label>
            </FlexItem>
          </Flex>
