        ...
        {isRunning ? (
          <>
            <FlexItem>
              ...
              >
                {isInProgress
                  ? words("dashboardV2.compileReports.running")
                  : words("dashboardV2.compileReports.queued")}
              </Content>
            </FlexItem>
            {report.started && (
              <FlexItem>
                <Content component="small">
                  {words("dashboardV2.compileReports.startedAgo")}{" "}
        ...
        <FlexItem>
          <Link to={{ pathname: detailsUrl, search: location.search }}>
            <Button variant="link" isInline>
              {isRunning
                ? words("dashboardV2.compileReports.viewProgress")
                : words("dashboardV2.compileReports.viewReport")}{" "}
              &gt;
            </Button>
          </Link>
        </FlexItem>
