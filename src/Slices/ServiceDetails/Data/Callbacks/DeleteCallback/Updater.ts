import { ApiHelper, Query, RemoteData, StateHelperWithEnv, UpdaterWithEnv } from "@/Core";
...
export class CallbacksUpdater implements UpdaterWithEnv<"GetCallbacks"> {
  ...
  async update(query: Query.SubQuery<"GetCallbacks">, environment: string): Promise<void> {
