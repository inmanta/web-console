        ...
        <Flex direction={{ default: "column" }} spaceItems={{ default: "spaceItemsMd" }}>
          <Flex justifyContent={{ default: "justifyContentSpaceBetween" }}>
            ...
            <FlexItem>
              ...
              >
                {words("dashboard.environmentHealth.switch")} &gt;
              </Button>
            </FlexItem>
          </Flex>
          <FlexItem>
            <Content component="small">
              {words("dashboard.environmentHealth.orchestratorLabel")}
            </Content>
          </FlexItem>
          <Flex
            alignItems={{ default: "alignItemsCenter" }}
            ...
            <Flex direction={{ default: "column" }} spaceItems={{ default: "spaceItemsXs" }}>
              <FlexItem>
                <Content component="h4">
                  {operational
                    ? words("dashboard.environmentHealth.operational")
                    : words("dashboard.environmentHealth.status.attention")}
                </Content>
              </FlexItem>
              {checklist.map((item) => (
