...
import { MenuToggle, MenuToggleElement, Select, Stack, StackItem, Title } from "@patternfly/react-core";
 ...
 */
export const StatusFilterSelect: React.FC<StatusFilterSelectProps> = ({ selectedStatuses, onChange }) => {
