...
interface FilterWidgetComponentProps {
  ...
  setFilter: (filter: Resource.FilterFromVersion) => void;
}

/**
 * The FilterWidgetComponent component.
 *
 * Drawer panel content displaying the desired state details filter form.
 *
 ...
 *  @prop {Resource.FilterFromVersion} filter - Current filter state.
 *  @prop {(filter: Resource.FilterFromVersion) => void} setFilter - Setter to persist filter changes upstream.
 *
