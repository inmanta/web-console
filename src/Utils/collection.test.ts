...
describe("collection utils", () => {
  ...
  it("merge performs a deep merge of arrays of objects by index", () => {
    const target = {
      embedded: [{ a: 1, unchanged: "same" }, { a: { b: "c" } }],
    };
    ...
    expect(result).toEqual({
      embedded: [{ a: 2, unchanged: "same" }, { a: { b: "c", c: "d" } }],
    });
  });
