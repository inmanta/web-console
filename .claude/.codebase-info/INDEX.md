...
A React/TypeScript single-page application (SPA) serving as the frontend for the Inmanta Orchestrator platform. It provides a feature-rich UI for managing orchestration environments, services, deployments, and configurations.
